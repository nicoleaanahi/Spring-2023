...
1.  Before class starts, navigate to "Spring-2023" in your projects (upper right-hand corner of RStudio) and **pull.**
...
- Copy the **"weightdata.csv"** file from the Spring-2023 repo into your own private repo.  Put it in the **data** folder within **Week_02**.  
